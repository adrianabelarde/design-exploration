...
description: Apply Emil Kowalski's design-engineering philosophy to UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when building or reviewing polished interfaces, refining interaction details, choosing motion behavior, or improving the craft and feel of frontend UI.
---
